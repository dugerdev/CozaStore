...
#region IRepository<T> Interface - Açıklamalar
/// <summary>
...
{
    #region Query Operations (Sorgu İşlemleri) - Açıklamalar
    /// <summary>
    ...
    #region Command Operations (Komut İşlemleri) - Açıklamalar
    /// <summary>
    ...
    #region Soft Delete Operations (Mantıksal Silme İşlemleri) - Açıklamalar
    /// <summary>
    ...
    #region Existence Control (Varlık Kontrolü) - Açıklamalar
    /// <summary>
